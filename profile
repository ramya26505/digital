...
<body>
        <header>
            <div class="header-content">
               ...
               <img src="R.Ramyakrishnan.jpeg" alt="your profile picture" class="profile=picture">
               <h1>R.Ramyakrishnan</h1>
            ...
            <section id="about">
                <div class="section-content">
                     <h2>About Me</h2>
                     <p>Hello Everyone! This is R.Ramyakrishnan and i am a computer science learner.</p>
                </div>
            </section>
